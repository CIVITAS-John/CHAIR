...
//await EvaluateModelsWithSameAnalyzer(GetMessagesPath("Coded Dataset 1"), "low-level-3", new RefiningReferenceBuilder()); 
await EvaluateModelsWithSameAnalyzer(GetMessagesPath("Coded Dataset 1"), "human", new RefiningReferenceBuilder()); 
process.exit(0);

await EvaluateModelsWithSameAnalyzer(GetMessagesPath("Coded Dataset 1"), "high-level-2-again", new RefiningReferenceBuilder());
